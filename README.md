...
get the app created:
    ...
    $ heroku apps:create cierne
    Creating cierne... done, stack is cedar
    http://cierne.herokuapp.com/ | git@heroku.com:cierne.git
...
You can deploy the skeleton project immediately:
    ...
    [...]
    -----> Launching... done, v3
           http://cierne.herokuapp.com deployed to Heroku

    To git@heroku.com:cierne.git
     * [new branch]      master -> master

It's live! Hit it with `curl`:

    $ curl http://cierne.herokuapp.com
    ["Hello" :from Heroku]
...
Then you can launch the REPL:
    ...
    $ lein repl :connect http://$REPL_USER:$REPL_PASSWORD@cierne.herokuapp.com/repl
